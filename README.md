...
**📄 استدلال کامل، صفحه‌به‌صفحه:** [سند اضطراب تا صفحه‌ی اول](https://claude.ai/code/artifact/ce036315-c7c6-4a6b-8c5f-93c06bdef3eb) (نسخه‌ی متنی‌اش هم در [`PRESENTATION.fa.md`](./PRESENTATION.fa.md) هست)
...
PRESENTATION.md              نسخه‌ی متنی بریف ارائه (انگلیسی)
PRESENTATION.fa.md           نسخه‌ی متنی بریف ارائه (فارسی)
...
| کیفیت تصمیمات محصولی و جزئیات تعامل | [سند راه‌حل](https://claude.ai/code/artifact/ce036315-c7c6-4a6b-8c5f-93c06bdef3eb) — استدلال هر صفحه ردیابی‌شده به یک اصل و یک محدودیت مشخص |
